...
<!--                        <span class="text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Created at</span>-->
            ...
            <Pagination
                :data="posts"
                @pagination-change-page="page => getPosts(page, search_category, search_id, search_title, search_content, orderColumn, orderDirection)"
            />
        </div>
    </div>
</template>
...
import useCategories from "../../composabales/categories";
